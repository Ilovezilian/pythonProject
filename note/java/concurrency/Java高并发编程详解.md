...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-5.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-7.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-15.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-28.png)
...
### [#](#_40-cyclicbarrier-同步屏障-了解吗) 40.CyclicBarrier（同步屏障）了解吗？
...
### [#](#_53-有哪几种常见的线程池) 53. 有哪几种常见的线程池？

面试常问，主要有四种，都是通过工具类 Excutors 创建出来的，需要注意，阿里巴巴《Java 开发手册》里禁止使用这种方式来创建线程池。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-71.png)
...
### [#](#_54-能说一下四种常见线程池的原理吗) 54. 能说一下四种常见线程池的原理吗？
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-72.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-73.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-74.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-75.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-76.png)
...
### [#](#_55-线程池异常怎么处理知道吗) 55. 线程池异常怎么处理知道吗？

在使用线程池处理任务的时候，任务代码可能抛出 RuntimeException，抛出异常后，线程池可能捕获它，也可能创建一个新的线程来代替异常的线程，我们可能无法感知任务出现了异常，因此我们需要考虑线程池异常情况。

常见的异常处理方式：

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-77.png)

### [#](#_56-能说一下线程池有几种状态吗) 56. 能说一下线程池有几种状态吗？
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-78.png)
...
### [#](#_57-线程池如何实现参数的动态修改) 57. 线程池如何实现参数的动态修改？

线程池提供了几个 setter 方法来设置线程池的参数。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-79.png)

这里主要有两个思路：

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-80.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-81.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-82.png)

具体的调优案例可以查看参考 [7] 美团技术博客。

### [#](#_58-你能设计实现一个线程池吗) 58. 你能设计实现一个线程池吗？
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-83.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-84.png)

这样，一个实现了线程池主要流程的类就完成了。

### [#](#_59-单机线程池执行断电了应该怎么处理) 59. 单机线程池执行断电了应该怎么处理？
...
关于一些并发容器，可以去看看 [面渣逆袭：Java 集合连环三十问 open in new window](https://mp.weixin.qq.com/s/SHkQ7LEOT0itt4bXMoDBPw)，里面有`CopyOnWriteList`和`ConcurrentHashMap`这两种线程安全容器类的问答。。

### [#](#_60-fork-join框架了解吗) 60.Fork/Join 框架了解吗？
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-85.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/sidebar/sanfene/javathread-86.png)
